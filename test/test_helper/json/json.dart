...
const jsonFilterCategoryList = {
  "drinks": [
    {"strCategory": "Ordinary Drink"},
  ]
};

const jsonFilterGlassList = {
  "drinks": [
    {"strGlass": "Highball glass"},
  ]
};

const jsonFilterAlcoholicList = {
  "drinks": [
    {"strAlcoholic": "Alcoholic"},
  ]
};
